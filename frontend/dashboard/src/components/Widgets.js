        ...
        <Card className="bg-secondary-alt shadow-sm">
            <Card.Header className="d-flex flex-row align-items-center flex-0">
                <div className="d-block">
                    ...
                    <h3>
                        {value}
                        <small className="text-muted"> Average Sentiment</small>
                    </h3>
                    <h3>
                        {count}
                        <small className="text-muted"> Tweets Found</small>
                    </h3>
                </div>
...
export const SentimentWidget = (props) => {
    const { icon, color, category, count, avgSentiment } = props;
        ...
        <Card border="light" className="shadow-sm">
            <Card.Body>
                <Row className="d-block d-xl-flex align-items-center">
                    ...
                    >
                        <div
                            className={`icon icon-shape icon-md text-${color} rounded me-4 me-sm-0`}
                        >
                            <FontAwesomeIcon icon={icon} />
                        </div>
                        <div className="d-sm-none">
                            <h5>{category}</h5>
                            <h3 className="mb-1">{avgSentiment}</h3>
                        </div>
                    </Col>
...
export const SentimentCircleWidget = (props) => {
            ...
            <Card.Body className="d-flex flex-row align-items-center flex-0 border-bottom">
                ...
                <div className="d-block ms-auto">
                    {data.map((d) => (
                        ...
                        >
                            <span
                                className={`shape-xs rounded-circle bg-${d.color} me-2`}
                            />
